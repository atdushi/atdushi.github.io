...
|[TopJava](https://github.com/java-repositories/TopJava33)|Приложение для подсчёта калорий|Maven, Spring MVC, Spring Security, REST (Jackson), Java 8 Stream API, Spring JDBC, JPA (Hibernate) и Spring Data JPA|
...
|Название|Описание|Технологии|
|------|------|------|
|[Airline Booking System](https://github.com/net-repositories/AirlineBookingSystem/tree/develop)|Приложение для демонстрации работы с RabbitMQ и другими технологиями|Microsoft SQL Server, MongoDB, Redis, RabbitMQ, Dapper ORM, MediatR, Docker|
...
|[Modern Structured Logging With Serilog and Seq](https://github.com/net-repositories/modern-structured-logging-serilog-seq)|Современное структурированное логирование с использованием Serilog и Seq|Serilog, RavenDB, Seq, Docker, Aspire|
